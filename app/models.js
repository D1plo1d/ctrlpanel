...
var PrintDriver, PrintJob, PrintQueue, config, driver, events, exec, fs, loadConfig, path, rest, rootDir, spawn, temp, testingDriver, yml,
...
PrintDriver = (function() {
  ...
  PrintDriver.prototype._initChildProc = function() {
    ...
    if (config.driver.spawn) {
      ...
      _ref = ["uncaughtException", "SIGINT", "SIGTERM"];
      _results = [];
